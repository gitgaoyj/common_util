...
import com.wode.common.frame.util.ConvertRegisterHelper;
import com.wode.common.frame.util.PageRequestFactory;
...
public class BaseSpringController extends MultiActionController{
	...
	protected  Logger logger = LoggerFactory.getLogger(BaseSpringController.class);
